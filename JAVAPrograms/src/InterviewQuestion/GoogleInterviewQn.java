...
/*
public class GoogleInterviewQn {
##Google Interview Questions: Product Marketing Manager
    ...
    Who are Google’s competitors, and how does Google compete with them? -- Google competes on numerous fields: --- Search: Baidu, Bing, Duck Duck Go --- Ads: Microsoft, Facebook, Comcast, Newspapers --- Social: Facebook and Twitter --- Mobile: Apple, Microsoft, RIM --- Desktop Operating System: Apple, Microsoft, Ubuntu, Fedora --- Office Suite: Microsoft, Open Office, Zoho --- TV: Apple, Microsoft, Samsung Smart TV --- Cable Internet: Comcast, Verizon, Time Warner, Quest/Century Link --- Online Videos: Vimeo, self hosted video, Apple/iTunes, Netflix, Amazon VOD --- Hardware: Apple, Nokia, Microsoft, HTC, Samsung, Acer, Vizio --- Music: Apple/iTunes, Amazon MP3, Not direct competition: Pandora, Mog, Last.fm --- Browsers: Microsoft IE, Firefox, Apple Safari, Opera

    Have you ever used Google’s products? Gmail? -- Yes, I use at least 10 Google products everyday: --- Gmail --- Google Search --- Google Drive --- Android --- Calendar --- Google+ --- Google Reader --- Chrome --- Google Voice --- YouTube

    What’s a creative way of marketing Google’s brand name and product? -- Show the power of Google's beam tool by playing phone tag from one side of the country (USA) to the other -- Travel around the world and communicate with every language by using Google Translate -- More Television commercials since most people just don't know about the products / features that Google offers and the TV is still the most used device which almost everyone has.
...
##Google Interview Questions: Software Engineer
    ...
    Why are manhole covers round? -- Man hole covers are round because it is the only shape that cannot fit within itself. -- Circles are the shape which requires the least amount of material to fit a full size man/woman -- Circular tubes are the strongest to hold off the forces of the earth, hence cause the man hole to be circular
    What is the difference between a mutex and a semaphore? Which one would you use to protect access to an increment operation?
    A man pushed his car to a hotel and lost his fortune. What happened? -- He didn't own the hotel on the monopoly board.
    ...
    What is the size of the C structure below on a 32-bit system? On a 64-bit? struct foo {
