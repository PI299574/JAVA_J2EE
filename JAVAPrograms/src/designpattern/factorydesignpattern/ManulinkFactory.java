...
class LoadMGA implements LoadPlan{
	...
	private void loadMGAData() {
		// TODO Auto-generated method stub
		System.out.println("MGA data has been load through MGA Apis.....");
	}
	
}
class LoadRetail implements LoadPlan{
	...
	private void loadRetailData() {
		// TODO Auto-generated method stub
		System.out.println("retail data has been load through MGA Apis.....");
	}
	
}

class LoadPlanFactory{
	
	public LoadPlan getLoadPlan(String p){
		if("MGA".equalsIgnoreCase(p)){
			return new LoadMGA();
		}
		else if("retail".equalsIgnoreCase(p)){
			return new LoadMGA();
		}
		return null;
		}
...
public class ManulinkFactory {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		LoadPlanFactory plan=new LoadPlanFactory();
		LoadPlan p=plan.getLoadPlan("MGA");
		p.loadData();
